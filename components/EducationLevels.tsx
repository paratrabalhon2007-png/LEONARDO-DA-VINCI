    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {EDUCATION_LEVELS.map((level, idx) => (
          <a 
            key={idx} 
            href={level.whatsappUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="group relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 border border-slate-100 flex flex-col cursor-pointer"
          >
            ...
            <div className="p-8 flex flex-col flex-grow">
              ...
              <div 
                className="inline-flex items-center text-school-lightBlue font-bold group-hover:translate-x-2 transition"
              >
                Saiba mais
